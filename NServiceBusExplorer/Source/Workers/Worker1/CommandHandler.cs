namespace Worker1
{
    ...
    class CommandHandler : IHandleMessages<ICommand>
    {
        ...
        {
            Console.WriteLine("HANDLER 0: Received request {0}.", message.CommandId);
            Console.WriteLine("HANDLER 0: Command text received: {0}.", message.CommandText);
            Console.WriteLine("HANDLER 0: Header 'Test' = {0}.", message.GetHeader("Test"));
